...
export default class Resources extends EventEmitter
{
    constructor()
    {
        ...
        this.loader.load([
            ...
            { name: 'projectsproject1Floor', source: './models/projects/project1/floorTexture.png', type: 'texture' },
            { name: 'projectsproject2Floor', source: './models/projects/project2/floorTexture.png', type: 'texture' },
